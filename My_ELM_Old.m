...
function [TrainingTime, TestingTime, TrainingAccuracy, TestingAccuracy] = My_ELM_Old(train_data, test_data, Elm_Type, NumberofHiddenNeurons, ActivationFunction)
